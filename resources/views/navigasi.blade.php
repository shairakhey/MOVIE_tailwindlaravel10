...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    ...
    <div class="w-1/3 pl-5">
        <a href="" class="uppercase text-base mx-5 text-black font-inter hover:text-develobe-500
    ...
    <div class="w-1/3 flex items-center justify-center">
        <a href="" class="font-bold text-5xl font-quicksand text-black hover:text-develobe-500
        duration-200">
            MOVIES-21
        </a>
    </div>
    ...
    <div class="w-1/3 flex flex-row justify-end pr-10">
        <a href="" class="group">
            <svg width='32' height='32' role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>SearXNG</title>
